return {
  ...
  -- basic settings:
  name = 'DuckmensionVS', -- name of the game for your executable
  developer = 'Advil Lavs', -- dev name used in metadata of the file
  output = 'dist', -- output location for your game, defaults to $SAVE_DIRECTORY
  version = '0.9', -- 'version' of your game, used to name the folder in output
  ...
  icon = 'icon_big.png', -- 256x256px PNG icon for game, will be converted for you
  
  -- optional settings:
  use32bit = false, -- set true to build windows 32-bit as well as 64-bit
  identifier = 'com.love.duckmensionvs', -- macos team identifier, defaults to game.developer.name
